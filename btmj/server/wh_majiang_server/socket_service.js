...
exports.start = function(config, mgr) {
    ...
    io.sockets.on('connection', function(socket) {
        socket.on('login', function(data) {
            ...
            // console.log('roomInfo.gameMgr', roomInfo.gameMgr);
        ...
        // 财神
        socket.on('caishen', function(data) {
            return;
        });
        //碰
        ...
        socket.on('chi', function(data) {
            ...
            console.log("数据是是是", info);
            console.log("数据是是是pai", info.pai);
            console.log("数据是是是chiOptioned", info.chiOptioned);
            socket.gameMgr.chi(socket.userId, info.pai, info.chiOptioned);
        });
        //杠
        ...
        socket.on('setAllTings', function(data) {
            var userId = socket.userId;
            if (userId == null) {
                return;
            }
            socket.gameMgr.setAllTings(userId, data);
        });
        //聊天
