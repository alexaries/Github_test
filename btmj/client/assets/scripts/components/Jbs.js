cc.Class({
    ...
    onBtnDetailChange: function(event) {
        var name = event.target.name;
    ...
    //顶部按钮切换页面
    initEventWanfa: function(target) {
    ...
    //详情顶部按钮切换
    initEventDetail: function(target) {
    ...
    //刷新报名界面数据
    freshMatch: function(matchDatas) {
        var self = this;
    ...
    showMatchList: function(matchData) {
        this.node.active = true;
        console.log('matchData', matchData);

        this.freshMatch(matchData);
    },
    showBaoMingDetail: function(event) {
