cc.Class({
    ...
    //显示创建猜拳页面
    onBtnShowMorra: function() {
        this._guessV.active = true;
    },
    //关闭猜拳页面
    onBtnCloseMorra: function() {
        this._guessV.active = false;
    },
    onBtnSetConsu: function(ev, data) {
        if (data == 1) {
            this.consu = 1;
    ...
    //显示加入房间页面
    onBtnShowJoin: function() {
        this._seekboxV.active = true;
    },
    //关闭加入房间页面
    onBtnCloseJoin: function() {
    ...
    onBtnSetBonus: function(ev, data) {
        if (this.consu == 0) {
